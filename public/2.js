...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getSeries: function getSeries() {
      ...
      axios.get("".concat(BACKEND_ENDPOINT, "/api/auth/time-series"), config).then(function (res) {
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("button", { on: { click: _vm.getSeries } }, [_vm._v("Update")]),
          _vm._v(" "),
          _c("line-chart", {
            attrs: {
              chartdata: _vm.chart.chartData,
